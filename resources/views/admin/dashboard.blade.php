...
<body>
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12 mt-5">
                        <h3 class="page-title mt-3">Welcome Back {{$LoggedUserInfo->nama}}!</h3>
                        <ul class="breadcrumb">
            ...
            <img src="{{asset('img/administrator2.jpg')}}" alt="Gambar Dashboard" class="img-thumbnail d-flex justify-content-center">
        </div> <br> <br>
    </div>
