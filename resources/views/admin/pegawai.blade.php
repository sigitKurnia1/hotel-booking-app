            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12 mt-5">
                        <h3 class="page-title mt-3">Semua Pegawai</h3>
                    </div>
                </div>
            </div>
                                            ...
                                            <td class="text-right">
                                                <div class="dropdown dropdown-action"> 
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right"> 
                                                        <a class="dropdown-item" href="/admin/editPegawai/{{$item->id}}"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a>
                                                        <a class="dropdown-item" href="/admin/deletePegawai/{{$item->id}}"><i class="fas fa-trash-alt m-r-5"></i> Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
            ...
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li class="submenu"> <a href="#"><i class="fas fa-user"></i> <span> Pegawai </span> <span class="menu-arrow"></span></a>
                        <ul class="submenu_class" style="display: none;">
                            <li><a class="active" href="{{route('admin.adminPegawai')}}"> Semua Pegawai </a></li>
