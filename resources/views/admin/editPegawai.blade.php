...
<body>
    ...
    <div class="page-wrapper mt-3">
        <div class="content container-fluid">
            ...
            <form action="{{route('admin.updatePegawai')}}" method="post">
                @csrf
                ...
                <div class="row formtype">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Jabatan</label>
                            <select name="role" class="form-control" required value="{{$info->role}}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input name="tgl_lahir" type="date" class="form-control" required value="{{$info->tgl_lahir}}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="jenKel" class="form-control" required value="{{$info->jenKel}}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input name="kontak" type="text" class="form-control" required value="{{$info->kontak}}"/>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Alamat</label>
                            <input name="alamat" type="text" class="form-control" required value="{{$info->alamat}}"/>
