                        ...
                        <div class="row formtype">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="jenKamar" class="form-control" type="text" disabled value="{{$info->jenKamar}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Harga</label>
                                    <input name="harga" class="form-control" type="text" disabled value="{{$info->harga}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <img src="{{asset('img/'.$info->gambar)}}" alt="Gambar Kamar" class="img-thumbnail">
                                </div>
                            </div>
                        </div>
                    </form>
