            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12 mt-5">
                        <h3 class="page-title mt-3">Semua Kamar</h3>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-3">
                                    <div class="card mb-5 mb-lg-0">
                                        <div class="card-body">
                                            <h6 class="card-title text-muted text-uppercase text-center">{{$item->jenKamar}}</h6>
                                            <hr />
                                            <h6 class="card-title text-uppercase text-center">Rp. {{$item->harga}}</h6> <hr>
                                            <a href="/admin/editKamar/{{$item->id}}" class="btn btn-block btn-primary text-uppercase">Edit</a>
                                            <a href="/admin/detailKamar/{{$item->id}}" class="btn btn-block btn-primary text-uppercase">Detail</a>
                                            <a href="/admin/deleteKamar/{{$item->id}}" class="btn btn-block btn-primary text-uppercase">Delete</a>
                                        </div>
                                    </div> <br> <br>
                                </div>
                                @endforeach
            ...
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li class="submenu"> <a href="#"><i class="fas fa-key"></i> <span> Kamar </span> <span class="menu-arrow"></span></a>
                        <ul class="submenu_class" style="display: none;">
                            <li><a class="active" href="{{route('admin.adminKamar')}}">Semua Kamar </a></li>
