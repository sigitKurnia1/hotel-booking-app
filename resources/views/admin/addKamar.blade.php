...
<body>
    ...
    <div class="page-wrapper mt-3">
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{route('admin.storeKamar')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row formtype">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Jenis Kamar</label>
                                    <select name="jenKamar" class="form-control" required value="{{old ('jenKamar')}}">
                                        <option>VIP</option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Harga</label>
                                    <input name="harga" class="form-control" type="text" required value="{{old ('harga')}}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Gambar</label>
                                    <input name="gambar" class="form-control" type="file" required value="{{old ('gambar')}}">
                ...
                <ul>
                    ...
                    <li class="submenu"> <a href="#"><i class="fas fa-key"></i> <span> Kamar </span> <span class="menu-arrow"></span></a>
                        <ul class="submenu_class" style="display: none;">
                            ...
                            <li><a class="active" href="{{route('admin.adminAddKamar')}}"> Tambah Kamar </a></li>
                        </ul>
                    </li>
