...
<body>
    ...
    <div class="page-wrapper mt-3">
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{route('admin.adminUpdateKomentar')}}" method="post">
                        @csrf
                        ...
                        <div class="row formtype">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Nama</label>
                                    <input name="nama" class="form-control" type="text" readonly value="{{$info->nama}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Email</label>
                                    <input name="email" class="form-control" type="email" readonly value="{{$info->email}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Rating</label>
                                    <input name="rating" class="form-control" type="text" readonly value="{{$info->rating}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Status Publikasi</label>
                                    <select name="statPubilkasi" class="form-control">
