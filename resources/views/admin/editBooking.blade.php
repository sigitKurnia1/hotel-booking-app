                ...
                <div class="row formtype">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input name="nama" class="form-control" type="text" required value="{{$info->nama}}"/>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>kontak</label>
                            <input name="kontak" class="form-control" type="text" required value="{{$info->kontak}}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Email</label>
                            <input name="email" class="form-control" type="email" required value="{{$info->email}}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control" required value="{{$info->status}}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="statusNikah" class="form-control" required value="{{$info->statusNikah}}">
                                <option>Sudah Menikah</option>
                                <option>Belum Menikah</option>
                            </select>
                            <span class="text-danger">@error ('statusNikah') {{$message}} @enderror</span>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Tanggal Check-In</label>
                            <input name="checkIn" type="date" class="form-control" required value="{{$info->checkIn}}"/>
                            <span class="text-danger">@error ('checkIn') {{$message}} @enderror</span>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Tanggal Check-Out</label>
                            <input name="checkOut" type="date" class="form-control" required value="{{$info->checkOut}}"/>
                            <span class="text-danger">@error ('checkOut') {{$message}} @enderror</span>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Bentuk Pembayaran</label>
                            <select name="jenPembayaran" class="form-control" required value="{{$info->jenPembayaran}}">
                                <option>Transfer Bank</option>
                                <option>Datang Ke Tempat</option>
                            </select>
                            <span class="text-danger">@error ('jenPembayaran') {{$message}} @enderror</span>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Nama Bank</label>
                            <select name="bank" class="form-control" required value="{{$info->bank}}">
                                <option>BRI</option>
                                <option>BNI</option>
                            </select>
