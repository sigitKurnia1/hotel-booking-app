    ...
    <div class="container">
        ...
        <div class="container">
            <div class="navbar navbar-expand-lg navbar-white bg-light p-3">
                ...
                <a href="#pembayaran" class="text-secondary"
                    style="text-decoration: none; font-size: 14pt; margin-left: 50pt">Detail Pembayaran</a>
                <a href="#infoKamar" class="text-secondary"
                    style="text-decoration: none; font-size: 14pt; margin-left: 50pt">Informasi Kamar</a>
            </div>
        </div>
            ...
            <form action="{{route('traveler.makeBooking')}}" method="post">
                ...
                <div class="container bg-white">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-4">
                                <input type="text" class="form-control border border-primary text-secondary" name="nama" placeholder="Nama Lengkap" readonly value="{{$LoggedUserInfo->nama}}">
                                <p class="text-black" style="font-size: 10pt">Nama Sesuai Dengan Identitas / KTP</p>
                            </div>
                            <div class="col-4">
                                <input type="date" class="form-control border border-primary text-secondary" name="checkIn" placeholder="Check In" autofocus value="{{old('checkin')}}">
                                <p class="text-black" style="font-size: 10pt">Tanggal Check In</p>
                            </div>
                            <div class="col-4">
                                <input type="email" class="form-control text-secondary border border-primary" name="email" placeholder="Email" readonly value="{{$LoggedUserInfo->email}}">
                                <p class="text-black" style="font-size: 10pt">Email Aktif Anda</p>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-4">
                                <input type="tel" class="form-control border border-primary text-secondary" name="kontak" placeholder="Nomor Telepon Aktif" readonly value="{{$LoggedUserInfo->kontak}}">
                            </div>
                            <div class="col-4">
