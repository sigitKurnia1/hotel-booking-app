    ...
    <div class="container">
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-white bg-white p-3">
                ...
                <a href="{{route('auth.login')}}" class="nav-item btn btn-white text-primary border border-primary" style="margin-right: 25px">Masuk</a>
                <a href="{{route('auth.register')}}" class="nav-item btn btn-primary text-white">Daftar</a>
            </nav>
        </div>
                                ...
                                <h5 class="text-primary">Masuk</h4>
                                    <div class="conatiner mt-5">
                                        <form action="{{route('auth.changePassword')}}" method="post">
                                            ...
                                            <div class="form-group">
                                                <label class="text-secondary mb-1">Password Baru Anda</label>
                                                <input type="password" class="form-control border border-primary" name="newPassword" required> <br>
                                                <span class="text-danger">@error('newPassword') {{$message}}@enderror</span>
                                            </div>
                                            <div class="form-group">
                                                <label class="text-secondary mb-1">Ketik Password Baru Anda</label>
                                                <input type="password" class="form-control border border-primary" name="repeatPassword" required> <br>
                                                <span class="text-danger">@error('repeatPassword') {{$message}}@enderror</span>
                                            </div>
                                            <button type="submit" class="btn btn-primary mt-4 form-control">Ubah Password</button> <br> <br>
                                        </form>
                                    </div>
                            </div>
                        </div>
